...
Lorsque le nombre de mouvements tirés est augmenté à 12, tout en conservant le nombre de mouvements choisis à 5, MARC atteint la base en deux ou trois phases en moyenne. Là encore, des cas d’atteinte dès la première phase sont observés. 
Les temps enregistrés sont : 0.063000 secondes, 0.042000 secondes (atteinte avant la fin de la phase), 0.047000 secondes, et 0.059000 secondes.

Enfin, en augmentant à la fois le nombre de mouvements tirés à 12 et le nombre de mouvements choisis à 7, MARC atteint généralement la base en une ou deux phases, mais des variations sont notées. 
Les temps enregistrés : 5.792000 secondes, 1.415000 secondes (atteinte avant la fin de la phase), 0.171000 secondes, 3.790000 secondes, 1.333000 secondes (atteinte avant la fin), 1.509000 secondes (atteinte avant la fin), et 2.683000 secondes.
